                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="/productos/detalles/{{$producto->id}}"><button class="btn btn-warning">Detalle</button></a></td>
                            <td><a href="/productos/edit/{{$producto->id}}"><button class="btn btn-info">Edit</button></a></td>
                            <td>
